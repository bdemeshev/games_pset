...
\def\@ctext#1{\ifcase#1\or а\or б\or в\or
г\or д\or е\or ж\or з\or и\or к\or л\or м\fi}
\makeatother
\AddEnumerateCounter{\ctext}{\@ctext}{Second}

\renewcommand{\theenumi}{(\ctext{enumi})} % нумерация пунктов буквами русского алфавита
\renewcommand{\labelenumi}{(\ctext{enumi})}
\setlist[enumerate]{style=nextline, labelindent=\parindent,leftmargin=*} % новый пункт с новой строки
